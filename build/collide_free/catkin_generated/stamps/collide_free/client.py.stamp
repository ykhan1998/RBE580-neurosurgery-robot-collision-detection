...
def setpoint_client(mode):
    ...
    if mode == 2:
        entrance = []
        target = []
        entrance.append(float(input("Input desire x entrance position in Z frame in mm\n")))
        entrance.append(float(input("Input desire y entrance position in Z frame in mm\n")))
        entrance.append(float(input("Input desire z entrance position in Z frame\n")))
        entrance.append(1.0)
        target.append(float(input("Input desire x target position in Z frame in mm\n")))
        target.append(float(input("Input desire y target position in Z frame in mm\n")))
        target.append(float(input("Input desire z target position in Z frame in mm\n")))
        target.append(1.0)
        ...
        entrance.append(float(input("Input desire x entrance position in Z frame in mm\n")))
        entrance.append(float(input("Input desire y entrance position in Z frame in mm\n")))
        entrance.append(float(input("Input desire z entrance position in Z frame in mm\n")))
        entrance.append(1.0)
